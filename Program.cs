...
namespace HomeWorkGB
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Скорость нескольких разных сортировок на разных размерах массивов и разных диапазонах значений");
            Console.WriteLine();
            Console.WriteLine("________________________________________________________________________________________________________");
            Console.WriteLine("                       |               |               |               |               |               |");
            Console.WriteLine("     Размер массива    |      100      |      100      |    100 000    |    100 000    |  100 000 000  |");
            Console.WriteLine("   Диапазон значений   |      100      |    100 000    |      100      |    100 000    |   1 000 000   |");
            ...
            Console.Write   ($"Пузырьковая сортировка |  {buble[0]}   |  {buble[1]}   |  {buble[2]}   |  {buble[3]}   |               | ");
            Console.WriteLine();
            Console.WriteLine("_______________________|_______________|_______________|_______________|_______________|_______________|");
            Console.Write   ($"Блочная с авто         |  {bucket_auto[0]}   |  {bucket_auto[1]}   |  {bucket_auto[2]}   |  {bucket_auto[3]}   |  {bucket_auto[4]}   |");
            Console.WriteLine();
            Console.WriteLine("_______________________|_______________|_______________|_______________|_______________|_______________|");
            Console.Write   ($"Блочная с пузырьковой  |  {bucket_buble[0]}   |  {bucket_buble[1]}   |  {bucket_buble[2]}   |  {bucket_buble[3]}   |               |");
            Console.WriteLine();
            Console.WriteLine("_______________________|_______________|_______________|_______________|_______________|_______________|");
            Console.Write   ($"Блочная-подсчётом      |  {bucket_count[0]}   |  {bucket_count[1]}   |  {bucket_count[2]}   |  {bucket_count[3]}   |  {bucket_count[4]}   |");
            Console.WriteLine();
            Console.WriteLine("_______________________|_______________|_______________|_______________|_______________|_______________|");
            Console.Write   ($"Автосортировка         |  {auto[0]}   |  {auto[1]}   |  {auto[2]}   |  {auto[3]}   |  {auto[4]}   |");
            Console.WriteLine();
            Console.WriteLine("_______________________|_______________|_______________|_______________|_______________|_______________|");
            Console.ReadKey();
            Console.ReadKey();
        ...
        static void TestAll(int size, int value, List<string> buble, List<string> bucket_count, List<string> bucket_auto, List<string> bucket_buble, List<string> auto)
        {
            ...
            Sort sort = MaxBucketsSort.Sort;
            Test(bucket_count, sort, mas);
            if (size < 200_000)
            {
                sort = BucketSort.Sort;
                Test(bucket_buble, sort, mas1);
            }
            sort = BucketSort.SortAuto;
        ...
        static void Test(List<string> timer, Sort sort, int [] array)    //тест и замер производительности конкретного алгоритма
        {
        ...
        static int[] RandomArray(int size, int maxvalue)       
        {
            var rand = new Random();
